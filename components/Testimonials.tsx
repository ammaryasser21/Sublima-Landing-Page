...
const Testimonials = () => {
  return (
    ...
    >
      ...
      />
      <div className="grid gap-8 xl:w-[1216px] bg-[#F9FAFB] rounded-[32px] py-16 place-items-center ">
        <div className="content lg:w-[768px] text-center flex flex-col justify-center items-center">
          <h1 className="text-[#111827] text-[24px] leading-[32px] sm:text-[36px] sm:leading-[44px] font-medium pb-8">
