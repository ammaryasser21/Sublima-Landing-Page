    ...
    <section className="Hero-section flex items-center flex-col bg-[#F0F8FF] bg-[url('/bg.png')] bg-center rounded-3xl xl:w-[1300px] xl:h-[1103px] pt-16 pb-16">
          ...
          <div className="img pt-[67px] relative">
            ...
            <Image
              ...
              width={200}
              height={182.8}
              className="border-8px rounded-6 top-1/2 -left-[88px] translate-y-[-50%] absolute cursor-pointer"
            />
            <Image
              src="/hero3.png"
              alt=""
              width={240}
              height={94.3}
              className="border-8px rounded-6 top-[78.5%] -right-[40px] translate-y-[-50%] absolute cursor-pointer"
            />
          </div>
        </section>
  )
